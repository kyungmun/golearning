...
type ArithmeticServiceClient interface {
	...
	GetMultipulication(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Answer, error)
...
func (c *arithmeticServiceClient) GetMultipulication(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
	err := c.cc.Invoke(ctx, "/pb.ArithmeticService/GetMultipulication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArithmeticServiceServer interface {
	...
	GetMultipulication(context.Context, *OperationParameters) (*Answer, error)
...
func (UnimplementedArithmeticServiceServer) GetMultipulication(context.Context, *OperationParameters) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMultipulication not implemented")
}
...
func _ArithmeticService_GetMultipulication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OperationParameters)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArithmeticServiceServer).GetMultipulication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ArithmeticService/GetMultipulication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetMultipulication(ctx, req.(*OperationParameters))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArithmeticService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMultipulication",
			Handler:    _ArithmeticService_GetMultipulication_Handler,
		},
		{
	...
	Metadata: "proto/arithmetic_svc.proto",
}
